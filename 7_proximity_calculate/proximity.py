 ...
 # @Timestamp for Last Modification: 2022-05-10 19:46:59
 # @Description: This Python file is used to implement the proximity algorithm. 
 # Written by woochanghwang at 18/11/2020, and optimized by Min Li.
...
def main():
    network_file_in_sif = "663proteins.sif"
    drug_target_file = "module5_DTN.csv"
    seedgenes_file = "seedgenes.txt"
    output_file = "proximity_result.csv"
