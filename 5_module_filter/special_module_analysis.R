 ...
 # @Timestamp for Last Modification: 2022-01-22 09:47:53
 # @Description: GO & KEGG Enrichment Analysis of module.
 # It is strongly recommended that the number of modules analyzed at one time should be less than 16.

 # "node_Module.txt" is available from the R package ne.PCA, content like:
 # name   module
 # ACACA    1
 # GPI      2
...
# or
analysis_module <- c(1, 2, 4, 5, 6, 8, 11, 16, 17)
